...
void setup() {
  ...
  // Pompt the user for the port 
  String selectedValue = (String) JOptionPane.showInputDialog(null, "Choose the correct port", "Input", JOptionPane.INFORMATION_MESSAGE, null, Serial.list(), Serial.list()[0]);
  int port = Arrays.asList(Serial.list()).indexOf(selectedValue);
    
  size(500, 1000);
  surface.setResizable(false);
  graphs = new HashMap<String, Graph>();
  //text(Serial.list());
  // Open the port you are using at the rate you want:t
